 ...
 */
public class CsvMakeAnnotation {
    ...
    public static CsvFormatFile getCsvFormatFile(Class<?> clazz) {
    	
    	 return clazz.getAnnotation(CsvFormatFile.class);
	}
    ...
    public static CsvMappingParseRootElem getFieldCsvMappingParseRootElem(Field field) {
        return field.getAnnotation(CsvMappingParseRootElem.class);
    }
    ...
    public static FormatRootElem formatInfoClassRootElem(CsvMappingParseRootElem fieldClassMain2) {
        FormatRootElem format = new FormatRootElem();
        format.setName(fieldClassMain2.name());
        format.setIslist(fieldClassMain2.list());
        format.setStartRowsIterationLigne(fieldClassMain2.valuDebutLigne());
        format.setValuLongueurChaine(0);
