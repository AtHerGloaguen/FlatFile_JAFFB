 ...
 * 
 * <p>
 * Annotation qui sert é la description de la classe principale pour le mapping.
...
public @interface CsvMappingParseRootElem {
	...
	/**
	 * détermine é partir de quelle ligne commence cet élément.<br />
	 ...
	 * si la valeur est é true, indique le nom de la classe <br />
	 ...
	 *  est é utiliser, ou celle-ci ne sera pas traitée.
	 * 
	 * </p>
