 ...
 *         <p>
 *         Annotation qui sert a la description de la class principal pour le mapping. elle comporte les valeurs :<br/>
 *         </p>
 * @see #valuDebutLigne
 * @see #valuNumbLigne
...
public @interface PositionalMappingParseRootElem {
     ...
     * reconnaisance des chaine de carractere par exoression reguliere. <br />
     * elle signifi que c'est cette variable qui sera utiliser pour l'injectionbr /> par default. si la chaine ne match avec aucune expression
     */
     ...
     * <p>
     * si cette valeur est utiliser. <br>
     ...
     * </p>
     * <br/>
     * Attantion valeur par default est -X
     * 
     * @return
     */
     ...
     * @return
     */
    Class<?> befort() default Class.class;
