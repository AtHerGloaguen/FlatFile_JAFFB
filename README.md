...
This library is there to transform a flat file or a string into an object.
It works by annotation.


Cette librairie est là  pour transformer un fichier plat ou une chaine de caractère en objet.
